          ...
          <div className="max-w-md w-full bg-white rounded-[2.5rem] shadow-2xl border border-slate-200 p-8 text-center animate-in zoom-in-95 duration-300">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="flex-1 py-3.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold rounded-xl transition-all active:scale-95 flex items-center justify-center gap-2"
              >
